...
def setting_input():
    with open(setting, "w") as f:
        while True:
            print("How many like you want to do in a day? (enter to use default number: 999)")
            f.write(str(int(sys.stdin.readline().strip()or "999")) + "\n")
            print("How about unlike? (enter to use default number: 999)")
            f.write(str(int(sys.stdin.readline().strip()or "999")) + "\n")
            print("How many follow you want to do in a day? (enter to use default number: 350)")
            f.write(str(int(sys.stdin.readline().strip()or "350")) + "\n")
            print("How about unfollow? (enter to use default number: 350)")
            f.write(str(int(sys.stdin.readline().strip()or "350")) + "\n")
            print("How many comment you want to do in a day? (enter to use default number:100)")
            f.write(str(int(sys.stdin.readline().strip()or "100")) + "\n")
            print("Maximal likes in media you will like?")
            print("We will skip media that have greater like from this value (enter to use default number: 150)")
            ...
            print("we will skip media that have lesser follower from this value(enter to use default number: 250)")
            ...
            print("Maximal followers to following_ratio (enter to use default number: 10)")
            f.write(str(int(sys.stdin.readline().strip()or "10")) + "\n")
            ...
            print("we will skip media that have lesser media from this value (enter to use default number: 7)")
            f.write(str(int(sys.stdin.readline().strip()or "7")) + "\n")
            print("Delay from one like to another like you will perform (enter to use default number: 30)")
            f.write(str(int(sys.stdin.readline().strip()or "30")) + "\n")
            print("Delay from one unlike to another unlike you will perform (enter to use default number: 10)")
            f.write(str(int(sys.stdin.readline().strip()or "10")) + "\n")
            print("Delay from one follow to another follow you will perform (enter to use default number: 30)")
            f.write(str(int(sys.stdin.readline().strip()or "30")) + "\n")
            print("Delay from one unfollow to another unfollow you will perform (enter to use default number: 30)")
            f.write(str(int(sys.stdin.readline().strip()or "30")) + "\n")
            print("Delay from one comment to another comment you will perform (enter to use default number: 60)")
            f.write(str(int(sys.stdin.readline().strip()or "60")) + "\n")
            print("Want to use proxy? insert your proxy or leave it blank if no. (just enter)")
            f.write(str(str(sys.stdin.readline().strip()or "None")) + "\n")
...
def menu_setting():
    ...
    while ans:
        ...
        if ans=="1":
            ...
            print("this will clear all database except your user accounts and paramater settings")
            time.sleep(5)
            fh = open(hashtag_file, 'w')
            fh = open(users_file,'w')
            fh = open(whitelist, 'w')
...
bot = Bot(
            ...
            stop_words=['order','shop','store','free','doodleartindonesia','doodle art indonesia','fullofdoodleart','commission','vector','karikatur','jasa','open']
)
