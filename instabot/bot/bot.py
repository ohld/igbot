...
class Bot(object):
    def __init__(
        ...
        max_follows_per_day=random.randint(200, 300),
        max_unfollows_per_day=random.randint(100, 300),
        max_comments_per_day=random.randint(100, 200),
        max_blocks_per_day=random.randint(100, 300),
        max_unblocks_per_day=random.randint(100, 300),
        max_likes_to_like=random.randint(100, 300),
        min_likes_to_like=random.randint(100, 300),
        ...
        like_delay=random.randint(100, 400),
        unlike_delay=random.randint(100, 400),
        follow_delay=random.randint(100, 400),
        unfollow_delay=random.randint(100, 400),
        comment_delay=random.randint(100, 400),
        block_delay=random.randint(100, 400),
        unblock_delay=random.randint(100, 400),
        message_delay=random.randint(100, 400),
