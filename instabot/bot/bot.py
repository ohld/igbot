...
class Bot(object):
    def __init__(
        ...
        base_path="",
        proxy=None,
        max_likes_per_day=random.randrange(400,800),
        max_unlikes_per_day=random.randrange(300,500),
        max_follows_per_day=random.randrange(100,300),
        max_unfollows_per_day=random.randrange(50,150),
        max_comments_per_day=random.randrange(50,120),
        max_blocks_per_day=random.randrange(50,200),
        max_unblocks_per_day=random.randrange(50,200),
        max_likes_to_like=random.randrange(50,200),
        min_likes_to_like=random.randrange(50,200),
        max_messages_per_day=random.randrange(100,300),
        filter_users=True,
        ...
        like_delay=random.randrange(30,70),
        unlike_delay=random.randrange(30,70),
        follow_delay=random.randrange(30,70),
        unfollow_delay=random.randrange(30,70),
        comment_delay=random.randrange(30,70),
        block_delay=random.randrange(30,70),
        unblock_delay=random.randrange(30,70),
        message_delay=random.randrange(30,70),
        stop_words=("shop", "store", "free"),
        blacklist_hashtags=["#shop", "#store", "#free"],
        blocked_actions_protection=True,
        blocked_actions_sleep=False,
        blocked_actions_sleep_delay=random.randrange(300,500),
        verbosity=True,
        device=None,
        save_logfile=True,
        log_filename=None,
