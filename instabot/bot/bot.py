...
class Bot(object):
    def __init__(
        ...
        base_path="",
        proxy=None,
        max_likes_per_day=732,
        max_unlikes_per_day=391,
        max_follows_per_day=162,
        max_unfollows_per_day=102,
        max_comments_per_day=72,
        max_blocks_per_day=113,
        max_unblocks_per_day=82,
        max_likes_to_like=100,
        min_likes_to_like=20,
        max_messages_per_day=263,
        filter_users=True,
        ...
        blocked_actions_sleep_delay=420,
        verbosity=True,
        device=None,
        save_logfile=True,
        log_filename=None,
