...
class FollowFromFollowingOfMyFollowersAndPutLikes(FollowUserRelatedToMe):
    task_id = "follow_from_following_of_my_followers_and_put_likes"
    task_name = "Follow from following of my followers and put likes"
