...
class FollowFromFollowersOfMyFollowersAndPutLikes(FollowUserRelatedToMe):
    task_id = "follow_from_followers_of_my_followers_and_put_likes"
    task_name = "Follow from followers of my followers and put likes"
    ...
    def __compute_user_id__(self):
        return choose_random(self.bot.followers)
